...
// run with: node eip7503-extension.js
...
async function main() {
    ...
    console.log("use in circuit - Actual publicKey PKx BigInt:", babyJub.F.toObject(pubKey[0]).toString());
    console.log("use in circuit - Actual publicKey PKy BigInt:", babyJub.F.toObject(pubKey[1]).toString());
    ...
    console.log("Ciphertext:", ciphertext); // use that output in input.json
